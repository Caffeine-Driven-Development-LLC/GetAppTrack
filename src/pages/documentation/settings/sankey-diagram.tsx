  ...
  return (
    <DocumentationLayout>
      <Stack spacing={2}>
        ...
        <Typography>
          Sankey Diagrams show a visual representation of how many applications have progressed with a simple visual of bars and nodes. Each node represents an <Link href={"/documentation/settings/application-events"}>Application Event</Link>, and the size of the bar indicates the number of applications that have taken the path between two events. It can be overwhelming to have a node for each Application Event, so here you can pick what evens you want to track.
        </Typography>
        <Typography>
